            ...
            >
              ...
              >
                <Text
                  style={StyleSheet.applyWidth(
                    StyleSheet.compose(GlobalStyles.TextStyles(theme)['Text'], {
                      fontSize: { minWidth: Breakpoints.Laptop, value: 34 },
                ...
                <Text
                  style={StyleSheet.applyWidth(
                    StyleSheet.compose(GlobalStyles.TextStyles(theme)['Text'], {
                      fontSize: { minWidth: Breakpoints.Laptop, value: 10 },
                    }),
                    dimensions.width
                  )}
                >
                  ...
                  style={StyleSheet.applyWidth(
                    {
                      ...
                      marginTop: { minWidth: Breakpoints.Laptop, value: 5 },
                      minWidth: { minWidth: Breakpoints.Laptop, value: 150 },
                  ...
                  style={StyleSheet.applyWidth(
                    {
                      backgroundColor: [
                        ...
                        { minWidth: Breakpoints.Laptop, value: Live?.true },
                      ],
                      borderTopLeftRadius: {
                        minWidth: Breakpoints.Laptop,
                        value: 25,
                  ...
                  style={StyleSheet.applyWidth(
                    {
                      backgroundColor: [
                        ...
                        { minWidth: Breakpoints.Laptop, value: Playlist?.true },
                      ],
                      borderTopLeftRadius: {
                        minWidth: Breakpoints.Laptop,
                        value: 25,
